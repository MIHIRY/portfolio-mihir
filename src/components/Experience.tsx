  ...
  return (
    <section id="experience" className="py-16 sm:py-20 md:py-24 lg:py-32 px-8 sm:px-12 md:px-16 lg:px-24 bg-gray-50">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Timeline. Wrapped whole: the four entries, the dots and the rule all
            arrive together, so the line never draws itself in behind them.
            Reveal's transform makes this the containing block for the absolutely
            positioned dots — the same box `relative` already made it. */}
            ...
            return (
              ...
              >
                ...
                <div className={`ml-12 md:ml-0 md:w-1/2 ${isLeft ? 'md:pl-12' : 'md:pr-12'}`}>
                  <div className="bg-white rounded-xl p-6 border border-gray-100 transition-colors duration-200 hover:border-gray-300">
                    {/* Mobile date */}
                    <span
