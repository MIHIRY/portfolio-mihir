  ...
  return (
    <section id="about" className="py-16 sm:py-20 md:py-24 lg:py-32 px-8 sm:px-12 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
        ...
        {/* The skill pills ride in with this block rather than one by one. */}
        <Reveal delay={70} className="lg:col-span-8">
          ...
          <div className="flex flex-wrap gap-2">
            {siteConfig.skills.map((skill) => (
              <span
                key={skill}
                className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm sm:text-base font-medium"
              >
                {skill}
              </span>
            ))}
